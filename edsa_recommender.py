...
def main():
    ...
    page_options = ["Recommender System","Data Exploration", "Recommenders", "Developers"]
    ...
    if page_selection == "Recommenders":
        ...
        solution = st.selectbox("We have 2 models which we use to make recommendations, which one would you like to learn about?", ('Select Option','Content-Based Recommender', 'Collaborative Recommender'))
        ...
        if solution == "Collaborative Recommender":
            ...
            st.info("The class of collaborative filtering algorithms  can be divided into two sub-categories:")
            ...
            st.write("Our Collaborative Recommender is a model-based recommender, using the SVD model from the Surprise package.")
    ...
    if page_selection == "Data Exploration":
        ...
        option = st.selectbox("How would you like to analyse and view the data?", ('Select Option','Ratings', 'Movies', 'Genres', 'Actors & Directors'))
        ...
        if option == 'Ratings':          
            ...
            st.write("Approximately 80% of the movies have a rating of 3 or higher, making this is a collection of enjoyable movies.")
            ...
            st.write("With the most ratings, user **72315** has an average rating of 3.")
        ...
        if option == "Movies":
            ...
            st.write("**My Way (Mai Wei)** had a $300 million budget, whereas **Fateless (Sorstalansag)** had a $30 million budget.")
        ...
        if option == "Actors & Directors":
            ...
            st.write("**Stephen King and Shakespeare**? Well... It's more likely that these films were based on their literary work.")
